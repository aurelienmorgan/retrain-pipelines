...
from .legacy_launcher import retrain_pipelines_legacy as _retrain_pipelines_legacy
from .utils import animate_wave


@register_line_magic
def retrain_pipelines_legacy(command_str):
    ...
    _ = _retrain_pipelines_legacy(command_str, env)
...
def load_ipython_extension(ipython):
    ...
    """
    ipython.register_magic_function(retrain_pipelines_legacy, "line")
